...
impl TextKey {
    ...
    fn text(self, lang: UiLanguage) -> &'static str {
        match (lang, self) {
            ...
            (UiLanguage::Vi, Self::MenuWatches) => "👁 Theo dõi",
            (UiLanguage::En, Self::MenuWatches) => "👁 Watches",
            (UiLanguage::Vi, Self::SettingsTitle) => "⚙ Cài đặt",
            (UiLanguage::En, Self::SettingsTitle) => "⚙ Settings",
            (UiLanguage::Vi, Self::SettingsLanguage) => "Ngôn ngữ",
            (UiLanguage::En, Self::SettingsLanguage) => "Language",
            (UiLanguage::Vi, Self::SettingsNotifications) => "Thông báo",
            (UiLanguage::En, Self::SettingsNotifications) => "Notifications",
            (UiLanguage::Vi, Self::SettingsEnabled) => "Bật",
            (UiLanguage::En, Self::SettingsEnabled) => "On",
            (UiLanguage::Vi, Self::SettingsDisabled) => "Tắt",
            (UiLanguage::En, Self::SettingsDisabled) => "Off",
            (UiLanguage::Vi, Self::DestSavedTitle) => "✓ Đã đặt thư mục đích",
            (UiLanguage::En, Self::DestSavedTitle) => "✓ Default destination set",
            ...
            (UiLanguage::Vi, Self::MenuWatch) => "⟳ Đồng bộ",
            (UiLanguage::En, Self::MenuWatch) => "⟳ Sync",
